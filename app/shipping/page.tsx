        ...
        <section className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="border border-border p-6">
              ...
              <p className="text-xs text-muted-foreground mt-1">Free on orders over $100</p>
            </div>
            ...
            <div className="border border-border p-6">
              ...
              <p className="text-lg font-medium">$19.99</p>
              <p className="text-xs text-muted-foreground mt-1">Free on orders over $200</p>
            </div>
            ...
            <div className="border border-border p-6">
              ...
              <p className="text-lg font-medium">From $29.99</p>
            ...
            <div className="border border-border p-6">
              ...
              <p className="text-lg font-medium">$4.99</p>
